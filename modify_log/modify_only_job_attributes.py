...
def translate_cluster_types_toazure(log_dir):
    ...
    azure_aws_type_mapping = {
        ...
        "r5d.large":target_cluster_type,
        "m5a.xlarge":"Standard_D4s_v3",    
        "m4.xlarge":target_cluster_type,
        "m4.2xlarge":"Standard_D8s_v3",
        ...
        "c5.xlarge":"Standard_F4s",
        "m5d.2xlarge":"Standard_D8ads_v5",
        "m5.large":"Standard_F4s",
